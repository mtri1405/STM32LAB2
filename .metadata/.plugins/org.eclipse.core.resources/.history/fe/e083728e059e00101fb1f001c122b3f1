...
const uint16_t ENM[MAX_LED_MATRIX] = { ENM0_Pin, ENM1_Pin, ENM2_Pin, ENM3_Pin,
 ...
 */
void setMatrixBuffer_A() {
	uint8_t pattern_A[8] = { 0xFF, 0xFF, 0xC1, 0xB7, 0xB7, 0xC1, 0xFF, 0xFF };
